// auth/session.ts 模块，承载前端对应功能的页面、组件或请求封装。
import type { AuthSession, UserProfile } from '../api/types';

// 集中维护前端登录态存储键，便于认证失效时跨页面传递明确提示。
